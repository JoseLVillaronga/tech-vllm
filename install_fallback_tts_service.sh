#!/usr/bin/env bash
# ==============================================================================
# Script de Instalación del Servicio Systemd para Fallback TTS (edge-tts CPU)
# ==============================================================================
...
APP_SCRIPT="${PROJECT_DIR}/app_fallback_tts.py"
SERVICE_NAME="vllm-fallback-tts"
SERVICE_PATH="/etc/systemd/system/${SERVICE_NAME}.service"
PORT="18012"

echo "============================================================"
echo "⚙️  Configurando Servicio Systemd para Fallback TTS (CPU)"
echo "============================================================"
...
if [ ! -f "${APP_SCRIPT}" ]; then
    echo "❌ Error: No se encontró app_fallback_tts.py."
    exit 1
fi
...
[Unit]
Description=vLLM Fallback TTS Server (edge-tts CPU Streaming - 0 VRAM)
