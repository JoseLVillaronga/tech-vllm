...
@app.route("/api/rag/bases", methods=["GET"])
...
@app.route("/api/rag/bases", methods=["POST"])
...
@app.route("/api/rag/bases/clone-domain", methods=["POST"])
...
@app.route("/api/rag/bases/<table_name>", methods=["DELETE"])
