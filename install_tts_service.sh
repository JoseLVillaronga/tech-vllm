#!/usr/bin/env bash
# ==============================================================================
# Script de Instalación del Servicio Systemd para vLLM F5-TTS
# ==============================================================================
...
APP_SCRIPT="${PROJECT_DIR}/app_tts.py"
SERVICE_NAME="vllm-tts"
SERVICE_PATH="/etc/systemd/system/${SERVICE_NAME}.service"

echo "============================================================"
echo "⚙️ Configurando Servicio Systemd para vLLM TTS Server"
echo "============================================================"
...
if [ ! -f "${APP_SCRIPT}" ]; then
    echo "❌ Error: No se encontró app_tts.py."
    exit 1
fi
...
[Unit]
Description=vLLM OpenAI-Compatible F5-TTS Server
...
echo "▶️ Iniciando el servicio vLLM F5-TTS..."
systemctl start "${SERVICE_NAME}"

echo "============================================================"
echo "🎉 Servicio vLLM F5-TTS instalado e iniciado correctamente!"
echo "============================================================"
...
echo "  • Documentación:  Accede a http://localhost:8002/docs para ver Swagger"
echo "============================================================"
