...
* **Sesión 2026-09-01 (Invariantes Binarios en Gateway & Desacoplamiento de Open-WebUI):**
  ...
  * *Observación 8 (Invariante de Portabilidad y Prohibición de Rutas Absolutas - Anti-Hardcoded Paths):* Se formalizó el 5to Invariante Operativo del MEA v2.1 para erradicar la deuda técnica generada por rutas absolutas locales (`/home/jose/...`, `file:///...`, `C:\...`). Al exigir resolución relativa o dinámica en scripts, documentación y configuraciones, el sistema se vuelve 100% portable, reproducible y agnóstico a migraciones entre hosts, usuarios o contenedores Docker.
