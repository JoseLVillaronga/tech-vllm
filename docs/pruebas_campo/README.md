...
| **2026-09-03 (Mañana)** | [`prueba_campo_qwen35b_moe_llamacpp_2026-09-03.md`](prueba_campo_qwen35b_moe_llamacpp_2026-09-03.md) | `Qwen3.6-35B-A3B-Q4_K_M` (Llama.cpp Local) | **20.582 tokens** | `buscar_en_base_de_conocimiento`<br>`obtener_indice_biblioteca`<br>`obtener_estructura_documento`<br>`leer_documento_completo` (15 llamadas)<br>`generate_pdf_document` | **Inferencia agéntica ultrarrápida (50 t/s gen, 670 t/s prefill) con `llama-server`, 15 lecturas quirúrgicas y compilación de PDF oficial de 4 páginas.** |
| **2026-09-03 (Tarde)** | [`prueba_campo_rechunking_lancedb_y_optimizacion_rag_2026-09-03.md`](prueba_campo_rechunking_lancedb_y_optimizacion_rag_2026-09-03.md) | `Qwen3.6-35B-A3B-Q4_K_M` (Llama.cpp Local) | **17.171 tokens** | `obtener_indice_biblioteca`<br>`obtener_estructura_documento` (con `filtro`)<br>`leer_documento_completo` (7 llamadas) | **Re-chunking jerárquico en LanceDB, desarticulación de pseudo-tablas (CCCN de 2 a 3.300 chunks), GPS anti-desbordamiento (-98.3% tokens) y recuperación quirúrgica del Art. 957 CCCN.** |
| **2026-09-07 (Día)** | [`prueba_campo_olvido_selectivo_y_ventana_operativa_2026-09-07.md`](prueba_campo_olvido_selectivo_y_ventana_operativa_2026-09-07.md) | `gpt-oss-20b-Q4_K_M` (Llama.cpp Local) | **114.2K ➔ 29.5K tokens** | `buscar_en_base_de_conocimiento`<br>`leer_documento_completo`<br>`ContextPruner` (Gateway) | **Estrés de 30 turnos, diagnóstico del Context Crosstalk (>55k tokens), descubrimiento de la regla de ventana operativa (40-50% nominal), compactación de tools (-73.8% tokens, prefill de 45s a 6.6s) y honestidad epistémica probada.** |
| **2026-09-07 (Noche)** | [`prueba_campo_anti_crosstalk_y_foco_dinamico_2026-09-07.md`](prueba_campo_anti_crosstalk_y_foco_dinamico_2026-09-07.md) | `gpt-oss-20b-Q4_K_M` (Llama.cpp Local) | **31 Turnos (~1.1 MB)** | `buscar_en_base_de_conocimiento`<br>`obtener_estructura_documento`<br>`leer_documento_completo` | **Blindaje definitivo contra In-Turn Attention Decay mediante anclaje dinámico en tools, compactación selectiva del asistente, corrección de filtrado temático en LanceDB y cero colapsos en 31 turnos a ~4.500 tok/s.** |
