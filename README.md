...
> Para descargar y estructurar leyes, decretos o códigos de InfoLEG para el RAG, consultá el [**Manual de Extracción y Estructuración Normativa (`docs/MANUAL_EXTRACTOR_INFOLEG.md`)**](docs/MANUAL_EXTRACTOR_INFOLEG.md).
