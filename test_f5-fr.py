...
if os.path.exists(ref_audio_orig):
    ...
    print("🔊 Audio de référence converti en Mono 24kHz.")
else:
...
print("🎙️ Génération de l'audio cloné en français...")
f5tts.infer(
    ref_file=ref_audio_mono,
    ref_text=ref_text,
    gen_text=gen_text,
    speed=1.0,
    file_wave="resultado_clonado_fr.wav"
)

print("✅ Audio généré avec succès dans 'resultado_clonado_fr.wav'!")
